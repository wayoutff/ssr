  ...
  plop.setGenerator('React Component', {
    ...
    actions: () => {
      const actions = [
        {
          type: 'pretty-add',
          path: './main/components/{{properCase componentName}}/{{properCase componentName}}.tsx',
          templateFile: './config/plop/component/component.tsx.plop'
        },
        {
          type: 'pretty-add',
          path:
            './main/components/{{properCase componentName}}/{{properCase componentName}}.test.tsx',
  ...
  plop.setGenerator('Redux Reducer', {
    ...
    actions: () => {
      const actions = [
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/actions.ts',
          templateFile: './config/plop/reducer/actions.ts.plop'
        },
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/actions.test.ts',
          templateFile: './config/plop/reducer/actions.test.js.plop'
        },
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/reducer.ts',
          templateFile: './config/plop/reducer/reducer.ts.plop'
        },
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/reducer.test.ts',
          templateFile: './config/plop/reducer/reducer.test.js.plop'
        },
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/selectors.ts',
          templateFile: './config/plop/reducer/selectors.ts.plop'
        },
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/selectors.test.ts',
          templateFile: './config/plop/reducer/selectors.test.js.plop'
        },
        {
          type: 'pretty-add',
          path: './main/store/{{camelCase reducerName}}/types.ts',
